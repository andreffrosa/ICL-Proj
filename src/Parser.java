...
public class Parser implements ParserConstants {
  ...
  static final public ASTNode EL(ASTNode t1) throws ParseException {
  Token op;
  ASTNode t2;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case D_EQ:
  ...
  static final public List<Entry<String,ASTNode>> EE() throws ParseException {
  ASTNode t;
  Token id;
  List<Entry<String,ASTNode>> decls = new LinkedList<Entry<String,ASTNode>>();
    ...
    jj_consume_token(EQ);
    t = EM();
                          decls.add(new AbstractMap.SimpleEntry<String, ASTNode>(id.image, t));
    label_5:
    while (true) {
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
      case COMMA:
...
}
{
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x0,0x78010800,0x78010800,0x0,0x0,0x0,0x0,0x2000,0x400,0x1a6c120,0x400,0x400,0x0,0x1a6c120,};
   }
   private static void jj_la1_init_1() {
      jj_la1_1 = new int[] {0x100,0x0,0x0,0xc,0xc,0x30,0x30,0x40,0x0,0x4b,0x0,0x0,0x1,0x4b,};
   }
